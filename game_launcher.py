...
class GameLauncher:
    def __init__(self):
        ...
        # Create game cards with pure vibrant colors
        self.cards = [
            GameCard("Flappy Bird", 60, 140, 200, 220, (80, 90, 160), "🐦", COLOR_BIRD),
            GameCard("Snake", 340, 140, 200, 220, (80, 90, 160), "🐍", COLOR_SNAKE),
            GameCard("Pong", 620, 140, 200, 220, (80, 90, 160), "🏓", COLOR_PONG),
            GameCard("Monster Run", 900, 140, 200, 220, (80, 90, 160), "👾", COLOR_MONSTER),
            GameCard("Space", 480, 400, 200, 220, (80, 90, 160), "👽", COLOR_SPACE),
        ]
    ...
    def draw_header(self):
        ...
        header_rect = header_surf.get_rect(center=(SCREEN_WIDTH // 2, 50))
    ...
    def draw_footer(self):
        ...
        footer_rect = footer_surf.get_rect(center=(SCREEN_WIDTH // 2, SCREEN_HEIGHT - 25))
